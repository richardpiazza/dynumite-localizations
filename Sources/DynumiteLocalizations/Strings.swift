...
public extension Strings {
    enum Frequency: String, LocalizedStringConvertible {
        ...
        public var key: String {
            switch self {
            case .manual: strategy.key(from: "manual", prefix: prefix)
            case .hours24: strategy.key(from: "24hours", prefix: prefix)
            case .hours12: strategy.key(from: "12hours", prefix: prefix)
            case .hours6: strategy.key(from: "6hours", prefix: prefix)
            case .minutes60: strategy.key(from: "60minutes", prefix: prefix)
            case .minutes30: strategy.key(from: "30minutes", prefix: prefix)
            case .minutes15: strategy.key(from: "15minutes", prefix: prefix)
            }
        }
    }
}
